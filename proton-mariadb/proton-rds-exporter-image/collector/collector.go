...
var hostname = strings.Split(os.Getenv("POD_NAME"), "-")
var instance = os.Getenv("DB_POD_NAME_PRE") + "-" + hostname[len(hostname)-1]
var source_label = map[string]string{
	"name": instance,
}
